/* 자동 생성: characters.json → window.DATA_CHARACTERS (file:// 더블클릭 대응)
   대사·데이터 수정은 이 파일을 직접 편집하세요. */
window.DATA_CHARACTERS = {
  "player":  { "name": "{플레이어}", "portrait": null },
  "lucian":  { "name": "루시안",      "portrait": "assets/characters/char_lucian.png" },
  "edmund":  { "name": "에드먼드",     "portrait": "assets/characters/char_edmund.png" },
  ...
  "celeste": { "name": "셀레스트",     "portrait": "assets/characters/char_celeste.png" }
};
